...
-- Task 15
SELECT s.first_name + ' ' + s.last_name AS staff_name, st.store_name
FROM sales.staffs s
...
-- Task 18
SELECT DISTINCT c.first_name + ' ' + c.last_name AS customer_name, o.order_date
FROM sales.customers c
JOIN sales.orders o ON c.customer_id = o.customer_id;
GO

-- Task 19
SELECT c.first_name + ' ' + c.last_name AS customer_name, o.order_id, o.order_date
FROM sales.customers c
